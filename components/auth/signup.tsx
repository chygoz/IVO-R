...
export default function SignupComponent() {
  return (
    <Container className="px-4 md:px-8 py-8  min-h-[400px] w-full flex flex-col justify-center">
      <Card className="px-4 md:px-8 md:max-w-lg w-full md:mx-auto py-4 border border-solid  border-[#D1D1D1] rounded-[20px] flex flex-col items-center gap-2 justify-center">
        ...
        <p>Sign up your IVÓ E-commerce account</p>
        <CreateAccountForm />
        <p className="text-left w-full">
          Already have an account?{" "}
          <Link className="text-primary-500" href="/auth/signin">
            Sign in
          </Link>
        </p>
      </Card>
