...
const Copyright: React.FC<CopyrightProps> = ({ payment }) => {
  return (
    <div className="border-t border-gray-300 pt-5 pb-16 mb-16 sm:pb-20 md:pb-5  sm:mb-0">
      <Container className="flex flex-col-reverse md:flex-row text-center md:justify-between">
        <p className="text-body text-xs lg:text-sm leading-6">
          ...
          <a
            ...
            href={"https://www.ivocorporate.com"}
          >
            IVO(Parenting).
          </a>
          &nbsp; All rights reserved
        ...
        {payment && (
          <ul className=" md:flex flex-wrap justify-center items-center space-s-4 xs:space-s-5 lg:space-s-7 mb-1 md:mb-0 mx-auto md:mx-0">
            {payment?.map((item) => (
              <li
