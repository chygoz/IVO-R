      ...
      try {
        ...
        if (user.role === "seller") {
          ...
          if (user?.onboardingStatus && !user.onboardingStatus.completed) {
            ...
            if (isLocalhost) {
              router.push(`/${user.subdomain}/onboarding/${user.onboardingStatus.currentStep}`);
            } else {
          ...
          if (storeId && user.businessId !== storeId) {
            ...
            if (isLocalhost) {
              router.push(`/${user.subdomain}/dashboard`);
            } else {
          ...
          if ((user as any).businessRole === "admin") {
            if (isLocalhost) {
              router.push(`/${user.subdomain}/admin`);
            } else {
              window.location.href = `${PROTOCOL}://${user.subdomain}.${mainDomain}/admin`;
            }
          } else {
            if (isLocalhost) {
              router.push(`/${user.subdomain}/dashboard`);
